...
def fetch_galaxy_image(ra, dec, size=5, metafile=None):
    """
    ...
    Args:
        ...
        size (int): Size of the cutout in arcseconds
    ...
    """
    try:
        # Construct URL for grizli service
        url = f"https://s3.amazonaws.com/grizli-v1/Pipeline/{metafile}/Thumbnails/rgb_ra{ra:.6f}_dec{dec:.6f}_size{size}.png"
        ...
        if response.status_code == 200:
            ...
            logging.error(f"Failed to fetch galaxy image: HTTP {response.status_code}")
